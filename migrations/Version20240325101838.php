...
final class Version20240325101838 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE energy_monthly_consumption (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, energy_type_id INT DEFAULT NULL, consumption NUMERIC(13, 1) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, INDEX IDX_C9FB4645A76ED395 (user_id), INDEX IDX_C9FB464580726647 (energy_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
